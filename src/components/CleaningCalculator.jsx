...
const PRICE_DATA = {
  ...
  "base_prices": {
    "20": {"Поддерживающая":3690,"Генеральная":12490,"После ремонта":13990},
    "30": {"Поддерживающая":3690,"Генеральная":12490,"После ремонта":13990},
    "40": {"Поддерживающая":3890,"Генеральная":13990,"После ремонта":15490},
    "50": {"Поддерживающая":4090,"Генеральная":15490,"После ремонта":16990},
    "60": {"Поддерживающая":4290,"Генеральная":16990,"После ремонта":18490},
    "70": {"Поддерживающая":4490,"Генеральная":18490,"После ремонта":19990},
    "80": {"Поддерживающая":4690,"Генеральная":19990,"После ремонта":21490},
    "90": {"Поддерживающая":4890,"Генеральная":21490,"После ремонта":22990},
    "100": {"Поддерживающая":5290,"Генеральная":22490,"После ремонта":24490},
    "110": {"Поддерживающая":5740,"Генеральная":23490,"После ремонта":25990},
    "120": {"Поддерживающая":6190,"Генеральная":24490,"После ремонта":27490},
    "130": {"Поддерживающая":6640,"Генеральная":25490,"После ремонта":28990},
    "140": {"Поддерживающая":7090,"Генеральная":26490,"После ремонта":30490},
    "150": {"Поддерживающая":7540,"Генеральная":27490,"После ремонта":31990},
    "160": {"Поддерживающая":7990,"Генеральная":28490,"После ремонта":33490},
    "170": {"Поддерживающая":8440,"Генеральная":29490,"После ремонта":34990},
    "180": {"Поддерживающая":8890,"Генеральная":30490,"После ремонта":36490},
    "190": {"Поддерживающая":9340,"Генеральная":31490,"После ремонта":37990},
    "200": {"Поддерживающая":9790,"Генеральная":32490,"После ремонта":39490}
  },
  "addons": [
    {"name":"Створка окна изнутри (стандартное - мойка)","unit":"створ","price":{"Поддерживающая":500,"Генеральная":500,"После ремонта":500},"quantityInput":true},
    {"name":"Створка окна с обеих сторон (стандартное - мойка)","unit":"створ","price":{"Поддерживающая":750,"Генеральная":750,"После ремонта":750},"quantityInput":true},
    ...
    {"name":"Окна+балкон (комплекс)","unit":"комплекс","price":{"Поддерживающая":7500,"Генеральная":7500,"После ремонта":7500},"quantityInput":false},
     {"name":"make jul great again","unit":"GREAT ","price":{"Поддерживающая":1000000,"Генеральная":1000000,"После ремонта":1000000},"quantityInput":true}
  ]
};
