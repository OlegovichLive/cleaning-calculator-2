...
const PRICE_DATA = {
  ...
  "base_prices": {
    "20": {"Поддерживающая":2690,"Генеральная":9990,"После ремонта":10490},
  ...
  "addons": [
    ...
    {"name":"Чистка (пример: пылесос) ?","unit":"шт","price":{"Поддерживающая":1500,"Генеральная":0,"После ремонта":0},"quantityInput":false},
    {"name":"(прочие мелкие допы из таблицы)","unit":"шт","price":{"Поддерживающая":500,"Генеральная":0,"После ремонта":0},"quantityInput":false},
    {"name":"Мойка холодильника внутри","unit":"шт","price":{"Поддерживающая":800,"Генеральная":800,"После ремонта":800},"quantityInput":false},
    {"name":"Мытьё кухонных шкафов изнутри","unit":"шт","price":{"Поддерживающая":500,"Генеральная":500,"После ремонта":500},"quantityInput":false},
    {"name":"Уборка на балконе","unit":"30 мин","price":{"Поддерживающая":500,"Генеральная":500,"После ремонта":500},"quantityInput":false},
    {"name":"Мытьё посуды (комплект)","unit":"комплект","price":{"Поддерживающая":500,"Генеральная":500,"После ремонта":500},"quantityInput":true},
    {"name":"Глажка (час)","unit":"час","price":{"Поддерживающая":1000,"Генеральная":1000,"После ремонта":1000},"quantityInput":true},
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <footer className="text-xs opacity-70">Скопируйте этот компонент в ваш React-проект (Vite/CRA). Для стилей подключите Tailwind.</footer>
      </div>
    </div>
  );
}
